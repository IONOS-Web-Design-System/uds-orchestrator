...
const features = [
  {
    ...
    title: 'Web Hosting',
    description:
      'Launch your website with fast, reliable shared hosting. Includes free SSL, one-click WordPress install, and a 99.99% uptime guarantee.',
    badge: 'Most popular',
    price: 'From €3.00/mo',
    cta: 'Get web hosting',
  },
  {
    ...
    title: 'VPS Hosting',
    description:
      'Full root access on dedicated virtual resources. Scale CPU, RAM, and SSD storage independently as your business grows.',
    badge: null,
    price: 'From €2.00/mo',
...
// ─── Hero Section ──────────────────────────────────────────────────────────
// Dark background hero with headline, subline, and primary CTA button.
// ThemeInverter flips tokens automatically so text and interactive elements
// remain legible against the deep blue gradient.
...
function HeroSection() {
  return (
    <ThemeInverter>
      ...
      >
        {/* Decorative radial glow — sky-blue accent per brand identity */}
        <div
          aria-hidden
          style={{
            position: 'absolute',
            ...
            borderRadius: '50%',
            background:
              'radial-gradient(circle, rgba(17, 199, 230, 0.10) 0%, transparent 70%)',
            pointerEvents: 'none',
          }}
        />
        ...
        {/* Headline — Overpass, the IONOS brand typeface for marketing headings */}
        <h1
          style={{
        ...
        >
          Hosting, domains, and VPS from the provider trusted by 12 million
          customers across Europe. Start with a plan that grows with you.
        </p>

        {/* CTA group — sky color is the single focal-point CTA per IONOS brand rules */}
        <div
          style={{
            display: 'flex',
            gap: '16px',
        ...
        >
          <Button
            ...
            size="lg"
            style={{
              backgroundColor: 'var(--brand/ionos-sky-300)',
...
function FeatureCard({
  ...
  return (
    ...
    >
      {/* "Most popular" badge — only on the first card */}
      {badge && (
        <span
          style={{
            position: 'absolute',
      ...
      {/* Product icon — IONOS icon group, gradient badge container */}
      <div
        style={{
          width: '52px',
          height: '52px',
      ...
      {/* Description — flex-grow so all cards align their price/CTA at the bottom */}
      <p
        style={{
          fontFamily: 'var(--base/font/body)',
          fontSize: '0.9375rem',
      ...
      {/* Price — Overpass heading typeface for numerical emphasis */}
      <p
        style={{
          fontFamily: 'var(--base/font/heading)',
          fontSize: '1.25rem',
  ...
  return (
    ...
    >
      ...
      <div style={{ textAlign: 'center', marginBottom: '48px' }}>
        ...
        >
          Whether you're launching a personal blog or scaling an enterprise
          platform, we have the right plan for you.
        </p>
      </div>
...
export default function HeroFeatureGridWireframe() {
  return (
    <ThemeProvider brand="ionos" colorScheme="light" platform="comfortable">
      ...
      {/* Hero — dark gradient background, headline, subline, CTA */}
      <HeroSection />

      {/* 3-column feature card row — web hosting, VPS, domains */}
      <FeatureGridSection />
    </ThemeProvider>
  );
}
